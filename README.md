  ...
  <h1 align="center">CRUD MERN Stack Application</h1>

   <div align="center">
     Build this project step by step with our detailed tutorial on <a href="https://www.youtube.com/@javascriptmastery/videos" target="_blank"><b>Speedy.Dev</b></a> YouTube.
    </div>
</div>
...
1. 🤖 [Introduction](#introduction)
   ...
   🔗 [Step 1 : Setting up the MERN App](#tech-stack)
   
   🔗 [Step 2 : Connecting the Backend to the Database](#tech-stack)
   
   🔋 [Step 3 : Creating Models](#features)
   
   🔋 [Step 4 : Creating Schema ](#features)
   
   🔋 [Step 4 : Creating CRUD Routers - SAVE, GET, UPDATE, DELETE ](#features)

   🔋 [Step 4 : CORS POLICY ](#features)


## 🚨 Tutorial

This repository contains the code corresponding to an in-depth tutorial available on my YouTube channel, <a href="https://www.youtube.com/@javascriptmastery/videos" target="_blank"><b>Speedy.Dev</b></a>.
